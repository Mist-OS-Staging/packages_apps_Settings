...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
    ...
    protected int getPreferenceScreenResId() {
        return SystemProperties.getBoolean("persist.sys.settings.revamp_ui", false) ? R.xml.top_level_settings_v2 : R.xml.mist_top_level_settings;
    }
	...
	for (int i = 0; i < screen.getPreferenceCount(); i++) {
            ...
            if (isValid && pref.getLayoutResource() != R.layout.mist_dashboard_preference_top && 
                pref.getLayoutResource() != R.layout.mist_dashboard_preference_full && 
                ...
                pref.getLayoutResource() != R.layout.mist_dashboard_preference_bottom) {
                pref.setLayoutResource(R.layout.mist_dashboard_preference_middle);
            }
        }
